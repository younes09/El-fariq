<!-- main-sidebar -->
		...
		<aside class="app-sidebar sidebar-scroll">
			<div class="main-sidebar-header active">
				{{-- <a class="desktop-logo logo-light active" href="{{ url('/' . $page='index') }}"><img src="{{URL::asset('assets/img/football-icon-png.png')}}" class="main-logo" alt="logo"></a>
				<a class="desktop-logo logo-dark active" href="{{ url('/' . $page='index') }}"><img src="{{URL::asset('assets/img/football-icon-png.png')}}" class="main-logo dark-theme" alt="logo"></a>
				<a class="logo-icon mobile-logo icon-light active" href="{{ url('/' . $page='index') }}"><img src="{{URL::asset('assets/img/football-icon-png.png')}}" class="logo-icon" alt="logo"></a>
				<a class="logo-icon mobile-logo icon-dark active" href="{{ url('/' . $page='index') }}"><img src="{{URL::asset('assets/img/football-icon-png.png')}}" class="logo-icon dark-theme" alt="logo"></a> --}}
				الفريق
			</div>
				...
				<div class="app-sidebar__user clearfix">
					<div class="dropdown user-pro-body">
						...
						<div class="user-info">
							...
							<span class="mb-0 text-muted">أهلا بك في مسابقة الفريق</span>
						</div>
					</div>
				</div>
				<ul class="side-menu">
					...
					<li class="slide">
						<a class="side-menu__item" href="{{ url('home/2023') }}"><svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24" ><path d="M0 0h24v24H0V0z" fill="none"/><path d="M5 5h4v6H5zm10 8h4v6h-4zM5 17h4v2H5zM15 5h4v2h-4z" opacity=".3"/><path d="M3 13h8V3H3v10zm2-8h4v6H5V5zm8 16h8V11h-8v10zm2-8h4v6h-4v-6zM13 3v6h8V3h-8zm6 4h-4V5h4v2zM3 21h8v-6H3v6zm2-4h4v2H5v-2z"/></svg><span class="side-menu__label">الإدارة</span>{{-- <span class="badge badge-success side-badge">1</span> --}}</a>
					</li>
					@endif
